...
public class Matriz2x2 {
    ...
    public Matriz2x2 suma(Matriz2x2 m) {    
    	return new Matriz2x2(a + m.getA(), b + m.getB(), 
                            c + m.getC(), d + m.getD());
    }
    ...
    public Matriz2x2 multiplica(Matriz2x2 m) {
    	return new Matriz2x2(a * m.getA() + b * m.getC(), 
                            a * m.getB() + b * m.getD(), 
                            c * m.getA() + d * m.getC(), 
                            c * m.getB() + d * m.getD());
    }
    ...
    public Matriz2x2 inversa() {
    	...
    	double cI = (c * (-1)) / det;
    	double dI = (a) / det;
    	Matriz2x2 inversa = new Matriz2x2(aI, bI, cI, dI);
    	return inversa;
    }
     ...
     * representación es dee la forma:
<pre>
 ⎛ a  b ⎞
 ⎝ c  d ⎠
</pre>
    ...
    /* Método auxiliar de toString(): agrega espacios a la cadena hasta que
     * tenga longitud n. */
