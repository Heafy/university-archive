 ...
 *
 * <p>Las instancias de la clase Lista implementan la interfaz {@link Iterable},
 * por lo que el recorrerlas es muy sencillo:</p>
 *
<pre>
    for (String s : l)
...
public class Lista<T> implements Iterable<T> {
     ...
     * @return <tt>true</tt> si la lista es igual al objeto recibido;s
     *         <tt>false</tt> en otro caso.
     */
