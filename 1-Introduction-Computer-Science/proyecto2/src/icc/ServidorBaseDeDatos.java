...
public abstract class ServidorBaseDeDatos<T extends Registro> {
    ...
    public ServidorBaseDeDatos(String archivo, int puerto)
        ...
        bdd = creaBaseDeDatos();
        if (archivo != null) {
            System.out.println("Cargando base de datos de " + archivo + ".");
            BufferedReader in =
                new BufferedReader(
    ...
    public void guarda() {
        try {
            System.out.println("Guardando base de datos en " + archivo + ".");
            BufferedWriter out =
                new BufferedWriter(
            ...
            System.err.println("Ocurrió un error al guardar la base de datos.");
        }
    }
