...
/**
 * Clase para pruebas unitarias de la clase {@link Pelicula}.
 */
public class TestPelicula {
     ...
     * {@linkPelicula#Pelicula(String,int,double,int)}.
     */
    ...
    /**
     * Prueba unitaria para {@link Pelicula#getTituloProperty}.
     */
    @Test public void testGetTituloProperty() {
	int n = random.nextInt();
    	String titulo = String.valueOf(n);
	String director = String.valueOf(random.nextInt());
        int year = random.nextInt(2015);
	...
	int duracion = random.nextInt(300);     
        ...
        Assert.assertTrue(pelicula.getTituloProperty().get().equals(titulo));
    }

    /**
     * Prueba unitaria para {@link Pelicula#setDirector} y 
     * {@linkPelicula#getDirector}.
     */
  ...
  /**
     * Prueba unitaria para {@link Pelicula#getDirectorProperty}.
     */
    @Test public void testGetDirectorProperty() {
	int n = random.nextInt();
    	String titulo = String.valueOf(random.nextInt());
	String director = String.valueOf(n);
        int year = random.nextInt(2015);
	...
	int duracion = random.nextInt(300);     
        ...
        pelicula = new Pelicula(titulo, director, year, genero, duracion);
        Assert.assertTrue(pelicula.getDirectorProperty().get().equals(director));
    }

    /**
     * Prueba unitaria para {@link Pelicula#setYear} y {@link
     * Pelicula#getYear}.
     */
    ...
    /**
     * Prueba unitaria para {@link Pelicula#getYearProperty}.
     */
    @Test public void testGetYearProperty() {
       String titulo = String.valueOf(random.nextInt());
	String director = String.valueOf(random.nextInt());
	int year = random.nextInt(2015);
	String genero = String.valueOf(random.nextInt());
	...
	pelicula = new Pelicula(titulo,
        ...
        Assert.assertTrue(pelicula.getYearProperty().get() == year);
    }
    ...
    /**
     * Prueba unitaria para {@link Pelicula#getGeneroProperty}.
     */
    @Test public void testGetGeneroProperty() {
       int n = random.nextInt();
	String titulo = String.valueOf(n);
	String director = String.valueOf(n);
	int year = random.nextInt(2015);
	...
	int duracion = random.nextInt(300);
       ...
       Assert.assertTrue(pelicula.getGeneroProperty().get().equals(genero));
    }
    ...
    /**
     * Prueba unitaria para {@link Pelicula#getDuracionProperty}.
     */
    @Test public void testGetDuracionProperty() {
       	String titulo = String.valueOf(random.nextInt());
	String director = String.valueOf(random.nextInt());
	int year = random.nextInt(2015);
	String genero = String.valueOf(random.nextInt());
	...
	pelicula = new Pelicula(titulo,
        ...
        Assert.assertTrue(pelicula.getDuracionProperty().get() == duracion);
    }
	...
	int duracion = random.nextInt(300);
        ...
        pelicula = new Pelicula(titulo, 
				...
				genero, 
				duracion);
        Pelicula igual = new Pelicula(titulo,
				      director,
				      year,
				      genero,
				      duracion);
	...
	duracion = random.nextInt(300);
        ...
        Pelicula distinto = new Pelicula(titulo, 
					 director, 
					 year,
					 genero,
					 duracion);
