...
import edd.ArbolBinarioCompleto;
import edd.ArbolRojinegro;
import edd.Color;
import edd.VerticeArbolBinario;
...
public class TestArbolRojinegro {
    ...
    /* Valida el vértice de un árbol rojinegro, y recursivamente revisa sus
     * hijos. */
    ...
    /* Valida que los caminos del vértice a sus hojas tengan todos el mismo
       número de vértices negros. */
