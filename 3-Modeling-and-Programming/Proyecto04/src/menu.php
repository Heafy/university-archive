	...
	echo "<body>";
		echo "<center>";
			...
			echo "<div id='contenido'>";
				...
				echo "<h1 class ='title'>Menú</h1>";

					echo "<table>";
							echo "<tr>"; 
								echo "<th><ul class='lista'>
									<li><a href='bebidasCalientes.php'>Bebidas Calientes</a></li>
									<li><a href='bebidasFrias.php'>Bebidas Frías</a></li>
									<li><a href='pasteles.php'>Pasteles</a></li>
									<li><a href='crepas.php'>Crepas</a></li>
									<li><a href='refrescos.php'>Refrescos</a></li>
									<li><a href='sandwiches.php'>Sandwiches</a></li></ul></th>";
								echo "<th><img src='images/menu.jpg' width=300px height=200px border='2'></th>";
