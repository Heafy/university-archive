...
public class Encoder{
    ...
    private ArrayList<String> newAristas;
    ...
    /* Metodo para obtener la lista de las nuevas aristas.*/
    public ArrayList<String> getnewAristas(){
        return newAristas;
    }
     ...
     */
    public void processEdges(ArrayList<String> aristas){
        for(int i = 0; i < aristas.size(); i++){
            String[] arista = aristas.get(i).split("\\s*,\\s*");
            newAristas.add(reverseMap.get(arista[0]) + "," + reverseMap.get(arista[1]));
