...
reflexion a traves de transformaciones lineales
'''
import pylab as pl

pl.figure("Operadores de Reflexion")
...
axisx = ax.arrow(x0, y0*(-1), (x1-x0), (y1-y0)*(-1), head_width=0.3, head_length=0.3, color = 'green', label="Respecto al eje x")
# Reflexion respecto al eje y
axisy = ax.arrow(x0*(-1), y0, (x1-x0)*(-1), (y1-y0), head_width=0.3, head_length=0.3, color='blue', label="Respecto al eje y")
# Reflexion respecto al eje y = x
axisyx = ax.arrow(x0, y0, (y1-y0), (x1-x0), head_width=0.3, head_length=0.3, color='purple', label="Respecto al eje y=x")
