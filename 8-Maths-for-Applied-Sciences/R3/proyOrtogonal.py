...
fig = pl.figure("Operadores de proyeccion ortogonal")
...
b = Vector3D([x0,x1],[y0,y1],[z0,0], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(b)
# Proyeccion ortogonal respecto al plano xz
c = Vector3D([x0,x1],[y0,0],[z0,z1], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(c)
# Reflexion respecto al plano yz
d = Vector3D([x0,0],[y0,y1],[z0,z1], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(d)
