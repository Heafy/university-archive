...
fig = pl.figure("Operadores de reflexion")
...
b = Vector3D([x0,x1],[y0,y1],[z0,-z1], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(b)
# Reflexion respecto al plano xz
c = Vector3D([x0,x1],[y0,-y1],[z0,z1], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(c)
# Reflexion respecto al plano yz
d = Vector3D([x0,-x1],[y0,y1],[z0,z1], mutation_scale=20, lw=1, arrowstyle="-|>", color="k")
ax.add_artist(d)
