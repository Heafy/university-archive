...
public enum Protocolo {
     ...
     */
    public static String generaComando(Protocolo comando) {
        String cmd = "";
        switch (comando) {
        case ENVIAR_BASE_DE_DATOS:
            cmd = "ENVIAR_BASE_DE_DATOS";
            break;
        case REGISTRO_AGREGADO:
            cmd = "REGISTRO_AGREGADO";
            break;
        case REGISTRO_ELIMINADO:
            cmd = "REGISTRO_ELIMINADO";
            break;
        case REGISTRO_MODIFICADO:
            cmd = "REGISTRO_MODIFICADO";
            break;
        case COMANDO_INVALIDO:
        default:
