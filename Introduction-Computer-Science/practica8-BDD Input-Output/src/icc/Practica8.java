...
public class Practica8 {
    ...
    private static void busquedas(BaseDeDatosEstudiantes bdd) {
        ...
        Lista<Estudiante> r = bdd.buscaRegistros("nombre", nombre);
        if (r.getLongitud() == 0) {
        ...
        r = bdd.buscaRegistros("cuenta", String.valueOf(cuenta));
        if (r.getLongitud() == 0) {
            System.out.printf("\nNo se hallaron estudiantes " +
                              "con la cuenta \"%d\".\n",
                              cuenta);
    ...
    private static void uso() {
        System.out.println("Uso: java -jar practica8.jar [-g|-c] <archivo>");
        System.exit(1);
    }
